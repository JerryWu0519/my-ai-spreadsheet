...
import type { Provenance, ProvenanceCellKey } from '@/app/provenance/provenanceTypes';
import type {
...
interface EventTypes {
  ...
  // Deep-Traceability: provenance events
  provenanceChanged: (cellKey: ProvenanceCellKey) => void;
  provenanceSelected: (provenance: Provenance | null) => void;
}
